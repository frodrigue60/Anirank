...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Soporte API Anirank",
            "email": "admin@anirank.com"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
        "/admin/animes": {
            "post": {
                ...
                "description": "Create a new Anime (Post) in the database.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/animes/{id}": {
            "put": {
                ...
                "description": "Update an existing Anime by ID.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
            ...
            "delete": {
                ...
                "description": "Delete an existing Anime by ID.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/reports": {
            "get": {
                ...
                "description": "Admin endpoint to list all unresolved reports.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/reports/{id}/resolve": {
            "put": {
                ...
                "description": "Admin endpoint to mark a report as resolved.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/songs": {
            "post": {
                ...
                "description": "Create a new Song in the database. Optionally sync Artist relationships.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/songs/{id}": {
            "put": {
                ...
                "description": "Update an existing Song by ID. Optionally sync Artist relationships.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/admin/user-requests": {
            "get": {
                ...
                "description": "Admin endpoint to list all unresolved user requests.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/user-requests/{id}/resolve": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Admin endpoint to mark a specific user request as resolved.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/admin/variants": {
            "post": {
                ...
                "description": "Create a new Song Variant (video/audio link) in the database.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.SongVariant"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/variants/{id}": {
            "put": {
                ...
                "description": "Update an existing Song Variant by ID.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/comments": {
            "get": {
                "description": "Fetch paginated root comments for a specific entity (e.g. Song).",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Entity Type (e.g. App\\\\Models\\\\Song)",
                        "name": "entity_type",
                        "in": "query",
                        "required": true
                    },
            ...
            "post": {
                ...
                "description": "Create a new comment or a reply to an existing comment.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/comments/{id}/replies": {
            "get": {
                "description": "Fetch paginated replies for a specific parent comment.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/interactions/favorites": {
            "post": {
                ...
                "description": "Toggle the favorite status of a Song or Playlist for the authenticated user.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/interactions/feed": {
            "get": {
                "description": "Retrieve the latest ratings, reactions, and favorites across the platform.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/interactions/ratings": {
            "post": {
                ...
                "description": "Submit a rating (1-10) for a specific Song.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/interactions/reactions": {
            "post": {
                ...
                "description": "Submit a reaction (1 for like, -1 for dislike, 0 to clear) for a SongVariant or Comment.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/playlists/{id}/songs/reorder": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Reorder Data (song_id -\u003e position)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/reports": {
            "post": {
                ...
                "description": "Submit a report for an entity (User, Song, Comment, etc) as a user.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "domain.Comment": {
            ...
            "properties": {
                ...
                "user": {
                    "description": "Relational Output Data",
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.User"
                        }
        ...
        "domain.Playlist": {
            ...
            "properties": {
                ...
                "songs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.PlaylistSong"
                    }
                },
                "updated_at": {
                    "type": "string"
        ...
        "domain.Post": {
            ...
            "properties": {
                ...
                "external_links": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ExternalLink"
                    }
                },
                "format": {
                    "$ref": "#/definitions/domain.Format"
                },
                "format_id": {
                    "type": "integer"
                },
        ...
        "domain.Report": {
            ...
            "properties": {
                ...
                "source": {
                    "description": "E.g., 'web', 'app', 'ext'",
                    "type": "string"
                },
                "status": {
                    "description": "'pending', 'fixed'",
                    "type": "string"
                },
                "title": {
                    "type": "string"
        ...
        "domain.SongVariant": {
            ...
            "properties": {
                ...
                "video_src": {
                    "description": "Embedded Video Info to simulate 1:1 legacy relation without join overhead",
                    "type": "string"
                },
                "video_type": {
        ...
        "domain.Tournament": {
            ...
            "properties": {
                ...
                "matchups": {
                    "description": "Tree of matchups",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.TournamentMatchup"
                    }
                },
                "name": {
                    "type": "string"
                ...
                "status": {
                    "description": "draft, active, completed",
                    "type": "string"
                },
                "title": {
                    "type": "string"
        ...
        "domain.TournamentMatchup": {
            ...
            "properties": {
                ...
                "song_b_id": {
                    "description": "Nulable if waiting or got a bye",
                    "type": "integer"
                },
                "status": {

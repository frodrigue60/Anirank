  ...
  <div class="flex flex-col">
    {#if users.length > 0}
      {#each users as user, index}
        ...
        <div
          class="ranking-row grid grid-cols-[80px_1fr_100px_120px_120px_120px] gap-4 px-8 py-5 items-center transition-colors border-b border-white/5 last:border-0 hover:bg-white/5"
        >

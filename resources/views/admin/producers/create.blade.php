    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <a href="{{ route('admin.producers.index') }}"
                ...
                <i class="fa-solid fa-arrow-left mr-2"></i> BACK TO PRODUCERS
            </a>
            <h1 class="text-3xl font-bold text-white tracking-tight">Create Producer</h1>
            <p class="text-zinc-400 mt-1">Add a new production company or committee to the system.</p>
        </div>

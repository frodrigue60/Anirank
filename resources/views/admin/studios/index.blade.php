...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold text-white tracking-tight">Studios Management</h1>
                <p class="text-zinc-400 mt-1">Manage animation studios and production houses.</p>
            </div>
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('admin.studios.create') }}"
                    ...
                    <i class="fa-solid fa-plus mr-2"></i> CREATE STUDIO
                </a>
            </div>
        </div>
            ...
            <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-xl overflow-hidden">
                        ...
                        <tbody class="divide-y divide-zinc-800/50">
                            @foreach ($studios as $studio)
                                <tr class="hover:bg-zinc-800/30 transition-colors group">
                                    <td class="px-6 py-4 text-sm font-mono text-zinc-500">#{{ $studio->id }}</td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex flex-col">
                                                ...
                                                <span class="text-[10px] text-zinc-500 font-medium">Animation Studio</span>
                                            </div>
                                        </div>
                                    </td>
                ...
                <div class="bg-zinc-950/50 px-6 py-8 border-t border-zinc-800">
                    <div class="flex justify-center">
                        {{ $studios->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            </div>
        </div>

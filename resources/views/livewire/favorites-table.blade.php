<div wire:init="loadData" class="flex flex-col gap-10">
    {{-- Filters Bar --}}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="relative group">
                ...
                <div class="relative">
                    ...
                    <input wire:model.live.debounce.300ms="name" type="text" placeholder="Anime title..."
    ...
    <div class="min-h-[400px]">
        @if ($readyToLoad)
            ...
            @if ($songs->isEmpty())
                <div class="py-32 flex flex-col items-center justify-center text-center opacity-40">
                    ...
                    <p class="text-sm font-medium mt-2">Try adjusting your filters or add some themes to your favorites!
                    </p>
                </div>
            @endif
        @else
        ...
        @if ($hasMorePages && $readyToLoad)
            <div wire:intersect="loadMore" wire:key="intersect-favorites"
